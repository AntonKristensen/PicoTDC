...
fig1 = plot(energies, spread, c=:black, label="Ideal")
plot!(energies, energies - medi, c=:black, label="Syst Ideal")
plot!(energies,fiddispread, c=:blue, label="50ps")
plot!(energies, energies - fiddi, c=:blue, label="syst 50ps")
plot!(energies,hunnispread, c=:red, label="100ps")
plot!(energies, energies - hunni, c=:red, label="Syst 100ps")
plot!(energies,twospread, c=:green, label="200ps")
plot!(energies, energies - two, c=:green, label="Syst 200ps")
plot!(energies,treespread, c=:magenta, label="350ps")
