...
plot!(points, amount[1] *  pdf(Normal(med[1], spread[1]), points), label="Ideal fit", color=:black, linewidth=2)
plot!(thirtypoints, thirtyamount[1] *  pdf(Normal(thirtymedi[1], thirtyspread[1]), thirtypoints), label="30ps fit", color=:green, linewidth=2)
plot!(fiddipoints, fiddiamount[1] *  pdf(Normal(fiddimedi[1], fiddispread[1]), fiddipoints), label="50ps fit", color=:blue, linewidth=2)
plot!(hunnipoints, hunniamount[1] *  pdf(Normal(hunnimedi[1], hunnispread[1]), hunnipoints), label="100ps fit", color=:red, linewidth=2)
