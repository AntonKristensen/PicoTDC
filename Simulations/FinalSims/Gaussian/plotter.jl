...
fig2 = histogram(cutdata[:,1], bins=0:1:medi*range, color=:black, label="Simulation", alpha=1, size=(500,300), dpi=1000, legend=:topleft)
...
plot!(60:1:140, normalarea * pdf(Normal(100,10), 60:1:140), label="Normal, μ=100MeV, σ=10MeV)", linecolor=:red, linewidth=3)
